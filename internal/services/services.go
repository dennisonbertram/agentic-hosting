...
// tenantIDRe validates tenant IDs: lowercase hex, 1-64 chars (as generated by generateID).
var tenantIDRe = regexp.MustCompile(`^[a-z0-9]{1,64}$`)

// baseDomainRe validates base domain characters: lowercase alphanumeric, dots, hyphens.
var baseDomainRe = regexp.MustCompile(`^[a-z0-9.-]+$`)
